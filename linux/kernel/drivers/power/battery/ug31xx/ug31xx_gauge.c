...
#include "ug31xx_ggb_data_A400CG_3RD_20140408_153802.h"
#else // ME175CG && A450CG
#if defined(CONFIG_A450CG)
#include "ug31xx_ggb_data_A450CG_DEF_20140326_110948.h"
#else // ME175CG
...
#else	///< A400CG
	if(hwid == HW_ID_PR || hwid == HW_ID_MP || hwid == HW_ID_MP2 || is_A400CG_1600mA_device())
	{
		ggb_board_offset = -15;
		ntc_offset = 29;
		standby_current = 3;
