...
/* chris added: */
#if defined(CONFIG_ME302C_BATTERY) || defined(CONFIG_ME372CG_BATTERY) || defined(CONFIG_TX201LA_BATTERY_EC) || defined(CONFIG_ME372CL_BATTERY) || defined(CONFIG_ME175CG_BATTERY) || defined(CONFIG_PF400CG_BATTERY)|| defined(CONFIG_A400CG_BATTERY) || defined(CONFIG_ZC400CG_BATTERY) || defined(CONFIG_A450CG_BATTERY) || defined(CONFIG_FE171CG_BATTERY) || defined(CONFIG_ME171C_BATTERY)
...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_BASE_BATTERY, /* for asus base battery */
	POWER_SUPPLY_TYPE_BASE_AC,       /* for asus base AC */
	POWER_SUPPLY_TYPE_PAD_BAT,	/* ASUS Pad Battery */
	POWER_SUPPLY_TYPE_PAD_AC,	/* ASUS Pad AC */
